...
import { linkUrlPageToPerson } from '../api/people';

interface PersonLinkUrlPageModalProps {
  personId: string;
  personName: string;
  isOpen: boolean;
  onClose: () => void;
...
export function PersonLinkUrlPageModal({
  personId,
  personName,
  isOpen,
  onClose,
  linkedUrlPageIds,
}: PersonLinkUrlPageModalProps) {
  ...
  const linkMutation = useMutation({
    mutationFn: (urlPageId: string) => linkUrlPageToPerson(personId, urlPageId),
    onSuccess: () => {
